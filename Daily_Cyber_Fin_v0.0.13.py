...
# ⚠️ 關鍵修正：關閉安全濾網，避免 AI 拒絕回答資安攻防問題
SAFETY_SETTINGS = [
...
def run_security_mode(config):
    ...
    if "⚠️" not in selected_titles: # 確保有選出東西
        class_prompt = f"""
